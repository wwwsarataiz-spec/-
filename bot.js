...
bot.start(async (ctx) => {
    ...
    ctx.reply('مرحباً! استخدم الأزرار:', Markup.keyboard([['⛏️ ابدأ التعدين', '💰 مكافأة يومية'], ['🏆 لوحة الصدارة', '👤 حسابي'], ['📥 إيداع', '💸 سحب الأرباح']]).resize());
});

// أوامر السحب والإدارة مدمجة هنا بنفس المنطق السابق...
module.exports = bot;
